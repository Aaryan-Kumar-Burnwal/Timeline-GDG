...
export default function UpcomingEventsPage() {
  ...
  const seminars = [
    ...
    {
      title:
        "Keynote — Dr. A. S. Kiran Kumar (Former ISRO Chairman) : Innovation In Indian Space Programme",
      start: "09:40",
      end: "10:05",
    },
    {
    ...
    {
      title:
        "Samyak Jain (SDE , Opstree Solutions) : Interactive Game / Quiz (with Goodies)",
      start: "14:21",
      end: "14:31",
    },
    {
